...
/**
 * Created by LiaoXingyu on 31/05/2017.
 */
...
public class CustomMatchers {
	...
	private static boolean sameBitmap(Context context, Drawable drawable, int resourceId) {
		...
		if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
			otherDrawable = context.getResources().getDrawable(resourceId, context.getTheme());
		} else {
			otherDrawable = context.getResources().getDrawable(resourceId);
		}
		// FIXME: 31/05/2017 传进来的drawable和获取到的不一样。7.0系统。原因未知
